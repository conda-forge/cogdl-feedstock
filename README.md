About cogdl-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cogdl-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11464&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cogdl-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cogdl` can be installed with `conda`:
...
It is possible to list all of the versions of `cogdl` available on your platform with `conda`:
...
```
mamba search cogdl --channel conda-forge
```
...
mamba repoquery search cogdl --channel conda-forge

# List packages depending on `cogdl`:
mamba repoquery whoneeds cogdl --channel conda-forge

# List dependencies of `cogdl`:
mamba repoquery depends cogdl --channel conda-forge
```
